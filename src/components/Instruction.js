...
const desc = [
    '1、业务推广对象：2019年度参加高考的学生。',
    '2、业务推广内容：推广格物水滴APP，让参加高考的学生下载APP并使用APP内的高考报名功能。',
    '3、APP高考报名功能简介：使用APP进行高考模拟报告的同学，可以看到自己在报考学校和专业的成绩排名，并可以与其他报考者沟通交流。',
    '4、业务推广流程：业务推广者注册推广账号->推广下载格物水滴APP->向高考学生推广注册,填写学习经历中的高中经历->向高考学生推广高考报名功能。',
    '5、推广提成：按照每有效用户10元人民币计算推广提成。有效用户人数是指你所负责推广学校的有效用户数。'
];
...
class Instruction extends React.Component{
    ...
    render(){
        return(
            ...
            <Collapse accordion>
                <Panel header="格物水滴APP推广说明" key="1">
                <List
                bordered
                dataSource={desc}
                ...
                <Panel header="推广下载格物水滴APP" key="3">
                <Card
                    hoverable
                    style={{ width: 400,}}
                ...
                <Panel header="推广注册,填写学习经历" key="4">
                <Card
                    hoverable
                    style={{ width: 400,}}
