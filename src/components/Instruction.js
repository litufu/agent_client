...
const job = [
    ...
    '6、工作流程：业务推广者注册推广账号->推广下载格物水滴APP->向高考学生推广注册->向高考学生推广高考报名功能。各流程详情见各部分描述。',
    '7、格物水滴APP简介：格物水滴app有高考报名、同城交友等多种功能。其中高考报名功能主要为：使用APP进行高考志愿模拟填报的同学，可以看到自己在报考学校和专业的成绩排名，并可以与其他报考者沟通交流。',
];
